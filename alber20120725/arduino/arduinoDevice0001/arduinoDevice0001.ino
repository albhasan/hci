...
// Adapted from Martijn The -> post [at] martijnthe.nl
...
// Report the coordinates once in a while...
        if (c++ & 0x80){
          ...
          //Vertical mouse
            ...
            Serial.print(((x)/400)*2.54, DEC);//Serial.print(((x-vX)/400)*2.54, DEC);// Rotation in 3D-Z
            Serial.print(" M1_cm_y=");
            Serial.print(((y)/400)*2.54, DEC);//Serial.print(((y-vY)/400)*2.54, DEC);// Rotation in 3D-X

            Serial.print(" M2_cm_x=");
            Serial.print(((x2)/400)*2.54, DEC);//Serial.print(((x2-vX2)/400)*2.54, DEC);//  Rotation in 3D-Y
            Serial.print(" M2_cm_y=");
            Serial.print(((y2)/400)*2.54, DEC);//Serial.print(((y2-vY2)/400)*2.54, DEC);//  Also 3D-X 
